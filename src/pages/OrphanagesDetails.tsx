...
interface IOrphanagesDetaisParams {
    id: number;
}
...
export default function OrphanagesDetais() {
    const route = useRoute();
    const params = route.params as IOrphanagesDetaisParams;
    ...
    function handleContactWhatsApp() {
        const url = `whatsapp://send?text=Oie&phone=55${orphanage?.phone}`;
        Linking.openURL(url).then((data) => {
            console.log('whatsapp opened')
        }).catch((err) => {
            alert('É necessário ter o whatsapp instalado');
        });
    }
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.detailsContainer}>
                ...
                <RectButton style={styles.contactButton} onPress={handleContactWhatsApp}>
